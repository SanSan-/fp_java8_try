...
public class BankServiceTest {
    ...
    public void accountingPositive() {
        TryReader<BankConnection, Account> reader = open("Alice", "123", new BigDecimal("100.00")).mapReader(
            acc -> credit(acc, new BigDecimal("200.00")))
    ...
    public void accountingNegative() {
        TryReader<BankConnection, Account> reader = open("Bill", "435", new BigDecimal("50.00")).mapReader(
            acc -> credit(acc, new BigDecimal("100.00")))
